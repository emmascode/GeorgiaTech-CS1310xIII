...
#Add your code here!
def volume_and_area(my_dict):
    my_dict['volume'] = my_dict['length'] * my_dict['width'] * my_dict['height'] 
    my_dict['area'] = 2 *(my_dict['length'] * my_dict['width'] + my_dict['length'] * my_dict['height'] + my_dict['height'] * my_dict['width'])
    return my_dict
