...
def to_ordinal(my_int):
    if str(my_int)[-1] == '1' and my_int != 11:
        return str(my_int) + 'st'
    elif str(my_int)[-1] == '2' and my_int != 12:
        return str(my_int) + 'nd'
    elif str(my_int)[-1] == '3' and my_int != 13:
        return str(my_int) + 'rd'
    else:
        return str(my_int) + 'th'
