...
def string_type(my_string):
    if my_string == "":
        return 'empty'
    if len(my_string) == 1:
        return 'character'
    if len(my_string) >=1 and my_string.count(" ") == 0:
        return 'word'
    if my_string.count(" ") >= 1 and my_string.count('.') <= 1:
        return 'sentence'
    if my_string.count(" ") >= 1 and my_string.count('.') >= 1 and my_string.count('\n') <1:
        return 'paragraph'
    if my_string.count('\n') >= 1:
        return 'page'
